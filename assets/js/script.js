...
if (loginAlert) {
    ...
    if (!userLogin) {
        ...
        <div class="login-warning">
            ...
            <p>Silakan login terlebih dahulu untuk menggunakan fitur Profile.</p>

            <a href="login.html" class="btn-login-profile">
                Login Sekarang
            </a>
        </div>
        `;
